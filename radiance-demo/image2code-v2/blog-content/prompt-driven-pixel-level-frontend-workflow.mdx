...
description: '不是一句“照着图写页面”，而是一套可复用的前端生成流程。Version 2 进一步把 image2code skill 跑成可留痕的实战：layout 提取、element 提取、实现截图、diff 和 refine。'
pubDate: 2026-06-02
updatedDate: 2026-06-03
heroImage:
  url: '../../src/assets/placeholder.webp'
  alt: 'Prompt 驱动的像素级前端生成流程'
tags:
...
![Radiance image2code Version 2 bottom viewport](/image2code/radiance-v2-bottom.png)

这是同一页面的 full-page 截图，用来保留完整页面高度和滚动结果：

![Radiance image2code Version 2 full page](/image2code/radiance-v2-fullpage.png)
